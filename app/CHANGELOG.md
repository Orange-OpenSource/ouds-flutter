...
### Added
- [DemoApp][Library] Implementation of `Navigation Button` ([#417](https://github.com/Orange-OpenSource/ouds-flutter/issues/417))
...
### Fixed
- [Tool] Update MinimumOSVersion from 13.0 to 15.0 ([#877](https://github.com/Orange-OpenSource/ouds-flutter/issues/877))

## [2.0.0](https://github.com/Orange-OpenSource/ouds-flutter/compare/1.3.1...2.0.0) - 2026-06-19
### Added
- Add agents.md with skills to project ([#668](https://github.com/Orange-OpenSource/ouds-flutter/issues/668))
### Changed
