...
/// OUDS Sheets Bottom with fixed tabs at the top.
/// Used for demo screens where CustomizableTabs should stay fixed
/// while only the content scrolls.

class OudsSheetsBottomWithTabs extends StatefulWidget {
  /// Creates an OUDS Sheets Bottom with fixed tabs.
  const OudsSheetsBottomWithTabs({
    super.key,
    required this.title,
  ...
  /// The content of the sheets bottom (should include CustomizableTabs)
  final Widget sheetContent;

  final Function(bool)? onExpansionChanged;

  @override
  State<OudsSheetsBottomWithTabs> createState() =>
      OudsSheetsBottomWithTabsState();
}

class OudsSheetsBottomWithTabsState extends State<OudsSheetsBottomWithTabs> {
  bool expanded = true;
