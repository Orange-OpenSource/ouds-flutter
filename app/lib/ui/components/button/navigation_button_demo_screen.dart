...
/// This screen displays a navigation button demo and allows customization of button properties
class NavigationButtonDemoScreen extends StatefulWidget {
  final String? previousPageTitle;
  const NavigationButtonDemoScreen({super.key, this.previousPageTitle});

  @override
  State<NavigationButtonDemoScreen> createState() =>
      _NavigationButtonDemoScreenState();
}

class _NavigationButtonDemoScreenState
    extends State<NavigationButtonDemoScreen> {
      ...
      child: ButtonCustomization(
        child: Padding(
          ...
          child: Scaffold(
            ...
            appBar: MainAppBar(
              title: context.l10n.app_components_button_navigationButton_tech,
              showBackButton: true,
...
/// This widget represents the body of the screen where the navigation button demo and code will be displayed
...
class _BodyState extends State<_Body> {
  ...
  Widget build(BuildContext context) {
    ...
    return DetailScreenDescription(
      description:
          context.l10n.app_components_button_navigationButton_description_text,
      widget: Column(
        children: [
          _NavigationButtonDemo(),
          SizedBox(
...
/// This widget is now a StatefulWidget for the navigation button demo
class _NavigationButtonDemo extends StatefulWidget {
  @override
  State<_NavigationButtonDemo> createState() => _NavigationButtonDemoState();
}

class _NavigationButtonDemoState extends State<_NavigationButtonDemo> {
      ...
      children: [
        ...
        CustomizableChips<NavigationButtonLayoutEnum>(
          ...
          onSelected: (selectedOption) {
            setState(() {
              customizationState.selectedChevron = selectedOption;
            });
          },
        ),
