...
/// Screen for the [OudsSmallCardItem] component demo.
class SmallCardItemDemoScreen extends StatefulWidget {
  final String? previousPageTitle;

  const SmallCardItemDemoScreen({super.key, this.previousPageTitle});

  @override
  State<SmallCardItemDemoScreen> createState() =>
      _SmallCardItemDemoScreenState();
}

class _SmallCardItemDemoScreenState extends State<SmallCardItemDemoScreen> {
    ...
    return DetailScreenDescription(
      ...
      widget: Column(
        children: [
          ...
          Code(
            code: ListItemCodeGenerator.updateCardCode(context, isSmall: true),
          ),
...
class _SmallCardItemDemo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
...
class _CustomizationContentState extends State<_CustomizationContent> {
  ...
  List<Widget> _buildLeadingSection(
    ...
    return [
      ...
      // Icon size is not customizable for OudsSmallCardItem: leading/trailing
