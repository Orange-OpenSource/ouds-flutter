...
class BadgeCustomizationUtils {
  ...
  static String getSemanticLabel(
    ...
    String? numberText = customizationState.selectedType == BadgeEnumType.count
        ? getNumberText(customizationState)
        : null;
    String baseLabel = '';
    ...
    return numberText != null ? '$numberText $baseLabel' : baseLabel;
  }
