...
class TypographyScreen extends StatelessWidget {
      ...
      body: ListView(
        children: [
          ...
          Code(
            ...
            code:
                'OudsTheme.of(context).typographyTokens.typeDisplayLarge(context)',
          ),
          Padding(
            padding: EdgeInsetsDirectional.all(
              currentTheme.spaceScheme(context).paddingInlineTwoExtraLarge,
  ...
  List<FontTokenItem> _getFontTokenItems(
    ...
    return [
      FontTokenItem(
        ...
        family:
            currentTheme.typographyTokens
                .typeDisplayLarge(context)
                .fontFamily ??
            currentTheme.fontFamily,
        weight: currentTheme.typographyTokens
            .typeDisplayLarge(context)
            .fontWeight!,
        size: currentTheme.typographyTokens.typeDisplayLarge(context).fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeDisplayLarge(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeDisplayLarge(context)
            .letterSpacing!,
      ),
      FontTokenItem(
        ...
        weight: currentTheme.typographyTokens
            .typeDisplayMedium(context)
            .fontWeight!,
        size: currentTheme.typographyTokens
            .typeDisplayMedium(context)
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeDisplayMedium(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeDisplayMedium(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeDisplaySmall(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeDisplaySmall(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeHeadingXLarge(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeHeadingXLarge(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeHeadingLarge(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeHeadingLarge(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeHeadingMedium(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeHeadingMedium(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeHeadingSmall(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeHeadingSmall(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeBodyDefaultLarge(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeBodyDefaultLarge(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeBodyDefaultMedium(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeBodyDefaultMedium(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeBodyDefaultSmall(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeBodyDefaultSmall(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeBodyModerateLarge(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeBodyModerateLarge(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeBodyModerateMedium(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeBodyModerateMedium(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeBodyModerateSmall(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeBodyModerateSmall(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeBodyStrongLarge(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeBodyStrongLarge(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeBodyStrongMedium(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeBodyStrongMedium(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeBodyStrongSmall(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeBodyStrongSmall(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        family:
            currentTheme.typographyTokens
                .typeLabelDefaultXLarge(context)
                .fontFamily ??
            currentTheme.fontFamily,
        weight: currentTheme.typographyTokens
            .typeLabelDefaultXLarge(context)
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeLabelDefaultXLarge(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeLabelDefaultXLarge(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeLabelDefaultLarge(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeLabelDefaultLarge(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeLabelDefaultMedium(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeLabelDefaultMedium(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeLabelDefaultSmall(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeLabelDefaultSmall(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        family:
            currentTheme.typographyTokens
                .typeLabelModerateXLarge(context)
                .fontFamily ??
            currentTheme.fontFamily,
        weight: currentTheme.typographyTokens
            .typeLabelModerateXLarge(context)
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeLabelModerateLarge(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeLabelModerateLarge(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeLabelModerateSmall(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeLabelModerateSmall(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeLabelStrongXLarge(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeLabelStrongXLarge(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeLabelStrongLarge(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeLabelStrongLarge(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeLabelStrongMedium(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeLabelStrongMedium(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            ...
            .fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeLabelStrongSmall(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeLabelStrongSmall(context)
            .letterSpacing!,
      ...
      FontTokenItem(
        tokenName: "CodeMedium",
        style: currentTheme.typographyTokens.typeCodeMedium(context),
        family: "monospace",
        weight: currentTheme.typographyTokens
            .typeCodeMedium(context)
            .fontWeight!,
        size: currentTheme.typographyTokens.typeCodeMedium(context).fontSize!,
        lineHeight: roundToOneDecimal(
          currentTheme.typographyTokens.typeCodeMedium(context).height!,
        ),
        letterSpacing: currentTheme.typographyTokens
            .typeCodeMedium(context)
            .letterSpacing!,
        ...
        children: [
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(fontTokenItem.tokenName, style: fontTokenItem.style),
