...
class TypographyScreen extends StatelessWidget {
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsetsDirectional.all(
                  currentTheme.spaceScheme(context).paddingInlineTall),
              child: Column(
                children: [
                  Text(
  ...
  List<FontTokenItem> _getFontTokenItems(
      OudsThemeContract currentTheme, BuildContext context) {
    return [
      FontTokenItem(
        ...
        weight:
            currentTheme.typographyTokens.typeDisplayLarge(context).fontWeight!,
      ...
      FontTokenItem(
        ...
        weight: currentTheme.typographyTokens
            ...
            .fontWeight!,
        size:
            currentTheme.typographyTokens.typeDisplayMedium(context).fontSize!,
        lineHeight: roundToOneDecimal(
      ...
      FontTokenItem(
        ...
        family: currentTheme.fontFamily,
        weight:
            currentTheme.typographyTokens.typeDisplaySmall(context).fontWeight!,
      ...
      FontTokenItem(
        ...
        weight: currentTheme.typographyTokens
            ...
            .fontWeight!,
        size:
            currentTheme.typographyTokens.typeHeadingXLarge(context).fontSize!,
        lineHeight: roundToOneDecimal(
      ...
      FontTokenItem(
        ...
        family: currentTheme.fontFamily,
        weight:
            currentTheme.typographyTokens.typeHeadingLarge(context).fontWeight!,
      ...
      FontTokenItem(
        ...
        weight: currentTheme.typographyTokens
            ...
            .fontWeight!,
        size:
            currentTheme.typographyTokens.typeHeadingMedium(context).fontSize!,
        lineHeight: roundToOneDecimal(
      ...
      FontTokenItem(
        ...
        family: currentTheme.fontFamily,
        weight:
            currentTheme.typographyTokens.typeHeadingSmall(context).fontWeight!,
      ...
      FontTokenItem(
        ...
        size: currentTheme.typographyTokens
            .typeBodyDefaultLarge(context)
            .fontSize!,
        lineHeight: roundToOneDecimal(currentTheme.typographyTokens
            .typeBodyDefaultLarge(context)
            .height!),
        letterSpacing: currentTheme.typographyTokens
            .typeBodyDefaultLarge(context)
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsetsDirectional.symmetric(
          vertical: currentTheme.spaceScheme(context).rowGapShort),
      child: Row(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                    height: currentTheme.spaceScheme(context).fixedShorter),
                Text(
                  ...
                  style: currentTheme.typographyTokens
                      ...
                      .copyWith(
                          color:
                              currentTheme.colorScheme(context).contentMuted),
                ),
              ],
            ),
          ),
