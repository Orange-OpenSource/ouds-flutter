<h1 align="center">OUDS Theme Orange Compact Flutter Library</h1>

**Theme Orange Compact** is a theme for applications built using the OUDS framework. It includes predefined semantic tokens such as colors, typography, and spacing that are consistent with the core "Orange Compact" brand identity.
...
To use **Theme Orange Compact**, add it as a dependency in your `pubspec.yaml` file.

```yaml
dependencies:
  ouds_theme_orange_compact: ^1.1.0
```
