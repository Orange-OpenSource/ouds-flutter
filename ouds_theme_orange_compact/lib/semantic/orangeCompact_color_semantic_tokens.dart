...
import 'package:ouds_theme_orange_compact/semantic/orangeCompact_color_ai_semantic_tokens.dart';
...
class OrangeCompactColorSemanticTokens extends OudsColorSemanticTokens {
  const OrangeCompactColorSemanticTokens({
    OrangeCompactColorActionSemanticTokens actionColorTokens =
        const OrangeCompactColorActionSemanticTokens(),
    OrangeCompactColorAiSemanticTokens aiColorTokens =
        const OrangeCompactColorAiSemanticTokens(),
    OrangeCompactColorAlwaysSemanticTokens alwaysColorTokens =
        const OrangeCompactColorAlwaysSemanticTokens(),
    OrangeCompactColorBgSemanticTokens backgroundColorTokens =
        const OrangeCompactColorBgSemanticTokens(),
    OrangeCompactColorBorderSemanticTokens borderColorTokens =
        const OrangeCompactColorBorderSemanticTokens(),
    OrangeCompactColorContentSemanticTokens contentColorTokens =
        const OrangeCompactColorContentSemanticTokens(),
    OrangeCompactColorOpacitySemanticTokens opacityColorTokens =
        const OrangeCompactColorOpacitySemanticTokens(),
    OrangeCompactColorOverlaySemanticTokens overlayColorTokens =
        const OrangeCompactColorOverlaySemanticTokens(),
    OrangeCompactColorSurfaceSemanticTokens surfaceColorTokens =
        const OrangeCompactColorSurfaceSemanticTokens(),
    OrangeCompactColorRepositorySemanticTokens repositoryColorTokens =
        const OrangeCompactColorRepositorySemanticTokens(),
  }) : super(
         actionColorTokens: actionColorTokens,
         aiColorTokens: aiColorTokens,
