...
class OrangeCompactColorOpacitySemanticTokens extends OudsColorOpacitySemanticTokens {
  const OrangeCompactColorOpacitySemanticTokens({
    ...
    super.opacityTransparentInverseDark = ColorRawTokens.colorOpacityBlack0,
    super.opacityTransparentInverseLight = ColorRawTokens.colorOpacityWhite0,
