...
class OrangeCompactColorBorderSemanticTokens extends OudsColorBorderSemanticTokens {
  const OrangeCompactColorBorderSemanticTokens({
    ...
    super.borderMutedDark = ColorRawTokens.colorOpacityWhite120,
    super.borderMutedLight = ColorRawTokens.colorOpacityBlack120,
