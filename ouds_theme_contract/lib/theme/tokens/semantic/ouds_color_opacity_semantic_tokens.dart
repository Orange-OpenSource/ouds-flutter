...
abstract class OudsColorOpacitySemanticTokens {
  ...
  final Color opacityTransparentInverseDark;
  final Color opacityTransparentInverseLight;
  ...
  const OudsColorOpacitySemanticTokens({
    ...
    required this.opacityTransparentInverseDark,
    required this.opacityTransparentInverseLight,
