...
abstract class OudsColorContentSemanticTokens {
  ...
  final Color contentInverseDark;
  final Color contentInverseLight;
  ...
  final Color contentStatusInverseInfoDark;
  final Color contentStatusInverseInfoLight;
  final Color contentStatusInverseNegativeDark;
  final Color contentStatusInverseNegativeLight;
  final Color contentStatusInversePositiveDark;
  final Color contentStatusInversePositiveLight;
  final Color contentStatusInverseWarningDark;
  final Color contentStatusInverseWarningLight;
  ...
  const OudsColorContentSemanticTokens({
    ...
    required this.contentInverseDark,
    required this.contentInverseLight,
    ...
    required this.contentStatusInverseInfoDark,
    required this.contentStatusInverseInfoLight,
    required this.contentStatusInverseNegativeDark,
    required this.contentStatusInverseNegativeLight,
    required this.contentStatusInversePositiveDark,
    required this.contentStatusInversePositiveLight,
    required this.contentStatusInverseWarningDark,
