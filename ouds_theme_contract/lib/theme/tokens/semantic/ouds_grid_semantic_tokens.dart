...
abstract class OudsGridSemanticTokens {
  ...
  late double extraLargeColumnGap;
  late double extraLargeMargin;
  late int extraLargeMaxWidth;
  late int extraLargeMinWidth;
  late double largeColumnGap;
  late double largeMargin;
  late int largeMaxWidth;
  late int largeMinWidth;
