...
abstract class OudsColorActionSemanticTokens {
  ...
  final Color actionReadOnlyPrimaryDark;
  final Color actionReadOnlyPrimaryLight;
  final Color actionReadOnlySecondaryDark;
  final Color actionReadOnlySecondaryLight;
  final Color actionSelectedDark;
  final Color actionSelectedLight;
  final Color actionSupportDisabledDark;
  final Color actionSupportDisabledLight;
  ...
  const OudsColorActionSemanticTokens({
    ...
    required this.actionReadOnlyPrimaryDark,
    required this.actionReadOnlyPrimaryLight,
    required this.actionReadOnlySecondaryDark,
    required this.actionReadOnlySecondaryLight,
    required this.actionSelectedDark,
    required this.actionSelectedLight,
    required this.actionSupportDisabledDark,
    required this.actionSupportDisabledLight,
