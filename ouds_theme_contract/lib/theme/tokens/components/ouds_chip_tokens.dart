...
class OudsChipTokens {
  ...
  final double? spaceColumnGapBadgeChevron;
  ...
  OudsChipTokens({
    ...
    double? sizeMinWidth,
    double? spaceColumnGapBadgeChevron,
    ...
    spaceColumnGapBadgeChevron = spaceColumnGapBadgeChevron ?? providersTokens.spaceTokens.columnGap2xs,
    spaceColumnGapIcon = spaceColumnGapIcon ?? providersTokens.spaceTokens.columnGapXs,
    spacePaddingBlock = spacePaddingBlock ?? providersTokens.spaceTokens.paddingBlock2xs,
    spacePaddingBlockIconOnly = spacePaddingBlockIconOnly ?? providersTokens.spaceTokens.paddingBlockXs,
    spacePaddingInlineBadgeStart = spacePaddingInlineBadgeStart ?? providersTokens.spaceTokens.paddingInline4xs,
    spacePaddingInlineChevronEnd = spacePaddingInlineChevronEnd ?? providersTokens.spaceTokens.paddingInlineXs,
