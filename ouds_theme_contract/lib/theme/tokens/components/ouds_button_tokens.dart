...
class OudsButtonTokens {
  ...
  final double? spaceColumnGapChevron;
  final double? spaceColumnGapIcon;
  final double? spaceColumnGapIconChevron;
  final double? spaceInsetIconOnly;
  final double? spacePaddingBlock;
  final double? spacePaddingInlineChevronEnd;
  final double? spacePaddingInlineChevronStart;
  ...
  OudsButtonTokens({
    ...
    double? sizeMinWidth,
    double? spaceColumnGapChevron,
    double? spaceColumnGapIcon,
    double? spaceColumnGapIconChevron,
    double? spaceInsetIconOnly,
    double? spacePaddingBlock,
    double? spacePaddingInlineChevronEnd,
    double? spacePaddingInlineChevronStart,
    ...
    spaceColumnGapChevron = spaceColumnGapChevron ?? providersTokens.spaceTokens.columnGapXs,
    spaceColumnGapIcon = spaceColumnGapIcon ?? providersTokens.spaceTokens.columnGapSm,
    spaceColumnGapIconChevron = spaceColumnGapIconChevron ?? providersTokens.spaceTokens.columnGap2xs,
    ...
    spacePaddingInlineChevronEnd = spacePaddingInlineChevronEnd ?? providersTokens.spaceTokens.paddingInlineLg,
    spacePaddingInlineChevronStart = spacePaddingInlineChevronStart ?? providersTokens.spaceTokens.paddingInlineLg,
