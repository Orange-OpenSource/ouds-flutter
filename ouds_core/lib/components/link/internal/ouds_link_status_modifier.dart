...
class OudsLinkStatusModifier {
  ...
  Color getTextAndIconColor(OudsLinkControlState state) {
    ...
    final linkMonoTheme = OudsTheme.of(
      context,
    ).componentsTokens(context).linkMono;
    final onColoredSurface = OudsTheme.isOnColoredSurfaceOf(context);

    switch (state) {
      case OudsLinkControlState.enabled:
        return onColoredSurface
            ? linkMonoTheme.colorContentEnabled
            : linkTheme.colorContentEnabled;
      case OudsLinkControlState.hovered:
        return onColoredSurface
            ? linkMonoTheme.colorContentHover
            : linkTheme.colorContentHover;
      case OudsLinkControlState.focused:
        return onColoredSurface
            ? linkMonoTheme.colorContentFocus
            : linkTheme.colorContentFocus;
      case OudsLinkControlState.pressed:
        return onColoredSurface
            ? linkMonoTheme.colorContentPressed
            : linkTheme.colorContentPressed;
