...
class OudsControlBorderModifier {
  ...
  Color getBorderColor(OudsControlState state, bool error, bool selected, bool isHighContrast) {
      ...
      switch (state) {
        case OudsControlState.enabled:
          if (selected) {
            ...
            return isHighContrast ? colorScheme(context).contentDefault : colorScheme(context).actionSelected;
          } else {
        ...
        case OudsControlState.pressed:
          ...
          return isHighContrast ? colorScheme(context).contentDefault : colorScheme(context).actionPressed;
        case OudsControlState.focused:
