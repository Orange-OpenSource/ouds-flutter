...
class OudsButtonIconModifier {
  ...
  static Color _getFocusedIconColor(
    BuildContext context,
    OudsButtonAppearance appearance,
  ) {
  ...
  /// Private static method to get the icon color when the button is enabled.
  static Color _getEnabledIconColor(
    BuildContext context,
    OudsButtonAppearance appearance,
  ) {
    final theme = OudsTheme.of(context);
  ...
  static Color _getHoverIconColor(
    BuildContext context,
    OudsButtonAppearance appearance,
  ) {
    final theme = OudsTheme.of(context);
  ...
  static Color _getPressedIconColor(
    BuildContext context,
    OudsButtonAppearance appearance,
  ) {
    final theme = OudsTheme.of(context);
  ...
  static Color _getDisabledIconColor(
    BuildContext context,
    OudsButtonAppearance appearance,
  ) {
    final theme = OudsTheme.of(context);
