...
void main() {
  group('OudsDisplayText common behavior', () {
    testWidgets('renders the provided text', (tester) async {
      await tester.pumpWidget(
        testableWidget(const OudsDisplayText(text: 'Hello world')),
      );
    ...
    testWidgets('applies the color override when provided', (tester) async {
      await tester.pumpWidget(
        testableWidget(
          const OudsDisplayText(text: 'Colored text', color: Colors.red),
        ),
      );
    ...
    testWidgets('renders bold markdown syntax', (tester) async {
      await tester.pumpWidget(
        testableWidget(const OudsDisplayText(text: 'This is **bold** text')),
      );
