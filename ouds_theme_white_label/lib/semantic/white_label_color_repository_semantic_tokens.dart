...
class WhiteLabelColorRepositorySemanticTokens
    extends OudsColorRepositorySemanticTokens {
  const WhiteLabelColorRepositorySemanticTokens({
    super.repositoryAccentDefaultLight = ColorRawTokens.colorFunctionalSun500,
    super.repositoryAccentHighestLight =
        WhiteLabelColorRawTokens.colorWarmGray900,
    super.repositoryAccentLowLight = ColorRawTokens.colorFunctionalSun300,
    super.repositoryAccentLowestLight =
        WhiteLabelColorRawTokens.colorWarmGray100,
    super.repositoryAccentDefaultDark = ColorRawTokens.colorFunctionalSun500,
    super.repositoryAccentHighestDark =
        WhiteLabelColorRawTokens.colorWarmGray900,
    super.repositoryAccentLowDark = ColorRawTokens.colorFunctionalSun300,
    super.repositoryAccentLowestDark =
        WhiteLabelColorRawTokens.colorWarmGray100,
    super.repositoryInfoDefaultLight =
        ColorRawTokens.colorFunctionalDodgerBlue500,
    super.repositoryInfoHighestLight =
        ColorRawTokens.colorFunctionalDodgerBlue900,
    super.repositoryInfoLowLight = ColorRawTokens.colorFunctionalDodgerBlue300,
    super.repositoryInfoLowestLight =
        ColorRawTokens.colorFunctionalDodgerBlue100,
    super.repositoryInfoDefaultDark =
        ColorRawTokens.colorFunctionalDodgerBlue500,
    super.repositoryInfoHighestDark =
        ColorRawTokens.colorFunctionalDodgerBlue900,
    super.repositoryInfoLowDark = ColorRawTokens.colorFunctionalDodgerBlue300,
    super.repositoryInfoLowestDark =
        ColorRawTokens.colorFunctionalDodgerBlue100,
    super.repositoryNegativeDefaultLight =
        ColorRawTokens.colorFunctionalScarlet600,
    super.repositoryNegativeHighLight =
        ColorRawTokens.colorFunctionalScarlet700,
    super.repositoryNegativeHigherLight =
        ColorRawTokens.colorFunctionalScarlet800,
    super.repositoryNegativeHighestLight =
        ColorRawTokens.colorFunctionalScarlet900,
    super.repositoryNegativeLowLight = ColorRawTokens.colorFunctionalScarlet300,
    super.repositoryNegativeLowerLight =
        ColorRawTokens.colorFunctionalScarlet200,
    super.repositoryNegativeLowestLight =
        ColorRawTokens.colorFunctionalScarlet100,
    super.repositoryNegativeDefaultDark =
        ColorRawTokens.colorFunctionalScarlet600,
    super.repositoryNegativeHighDark = ColorRawTokens.colorFunctionalScarlet700,
    super.repositoryNegativeHigherDark =
        ColorRawTokens.colorFunctionalScarlet800,
    super.repositoryNegativeHighestDark =
        ColorRawTokens.colorFunctionalScarlet900,
    super.repositoryNegativeLowDark = ColorRawTokens.colorFunctionalScarlet300,
    super.repositoryNegativeLowerDark =
        ColorRawTokens.colorFunctionalScarlet200,
    super.repositoryNegativeLowestDark =
        ColorRawTokens.colorFunctionalScarlet100,
    super.repositoryNeutralEmphasizedBlackLight =
        ColorRawTokens.colorFunctionalBlack,
    super.repositoryNeutralEmphasizedHighLight =
        ColorRawTokens.colorFunctionalDarkGray720,
    super.repositoryNeutralEmphasizedHigherLight =
        ColorRawTokens.colorFunctionalDarkGray800,
    super.repositoryNeutralEmphasizedHighestLight =
        ColorRawTokens.colorFunctionalDarkGray880,
    super.repositoryNeutralEmphasizedMediumLight =
        ColorRawTokens.colorFunctionalDarkGray640,
    super.repositoryNeutralEmphasizedBlackDark =
        ColorRawTokens.colorFunctionalBlack,
    super.repositoryNeutralEmphasizedHighDark =
        ColorRawTokens.colorFunctionalDarkGray720,
    super.repositoryNeutralEmphasizedHigherDark =
        ColorRawTokens.colorFunctionalDarkGray800,
    super.repositoryNeutralEmphasizedHighestDark =
        ColorRawTokens.colorFunctionalDarkGray880,
    super.repositoryNeutralEmphasizedMediumDark =
        ColorRawTokens.colorFunctionalDarkGray640,
    super.repositoryNeutralMutedLowerLight =
        ColorRawTokens.colorFunctionalLightGray160,
    super.repositoryNeutralMutedLowestLight =
        ColorRawTokens.colorFunctionalLightGray80,
    super.repositoryNeutralMutedWhiteLight =
        ColorRawTokens.colorFunctionalWhite,
    super.repositoryNeutralMutedLowerDark =
        ColorRawTokens.colorFunctionalLightGray160,
    super.repositoryNeutralMutedLowestDark =
        ColorRawTokens.colorFunctionalLightGray80,
    ...
    super.repositoryOpacityBlackHigherLight =
        ColorRawTokens.colorOpacityBlack680,
    super.repositoryOpacityBlackHighestLight =
        ColorRawTokens.colorOpacityBlack840,
    super.repositoryOpacityBlackLowLight = ColorRawTokens.colorOpacityBlack200,
    super.repositoryOpacityBlackLowerLight = ColorRawTokens.colorOpacityBlack80,
    super.repositoryOpacityBlackLowestLight =
        ColorRawTokens.colorOpacityBlack40,
    super.repositoryOpacityBlackMediumLight =
        ColorRawTokens.colorOpacityBlack440,
    super.repositoryOpacityBlackSoftLight = ColorRawTokens.colorOpacityBlack280,
    super.repositoryOpacityBlackTransparentLight =
        ColorRawTokens.colorOpacityBlack0,
    super.repositoryOpacityBlackHighDark = ColorRawTokens.colorOpacityBlack520,
    super.repositoryOpacityBlackHigherDark =
        ColorRawTokens.colorOpacityBlack680,
    super.repositoryOpacityBlackHighestDark =
        ColorRawTokens.colorOpacityBlack840,
    super.repositoryOpacityBlackLowDark = ColorRawTokens.colorOpacityBlack200,
    ...
    super.repositoryOpacityBlackMediumDark =
        ColorRawTokens.colorOpacityBlack440,
    super.repositoryOpacityBlackSoftDark = ColorRawTokens.colorOpacityBlack280,
    super.repositoryOpacityBlackTransparentDark =
        ColorRawTokens.colorOpacityBlack0,
    ...
    super.repositoryOpacityWhiteHigherLight =
        ColorRawTokens.colorOpacityWhite800,
    super.repositoryOpacityWhiteHighestLight =
        ColorRawTokens.colorOpacityWhite920,
    super.repositoryOpacityWhiteLowLight = ColorRawTokens.colorOpacityWhite200,
    super.repositoryOpacityWhiteLowerLight = ColorRawTokens.colorOpacityWhite80,
    super.repositoryOpacityWhiteLowestLight =
        ColorRawTokens.colorOpacityWhite40,
    super.repositoryOpacityWhiteMediumLight =
        ColorRawTokens.colorOpacityWhite560,
    super.repositoryOpacityWhiteTransparentLight =
        ColorRawTokens.colorOpacityWhite0,
    super.repositoryOpacityWhiteHighDark = ColorRawTokens.colorOpacityWhite640,
    super.repositoryOpacityWhiteHigherDark =
        ColorRawTokens.colorOpacityWhite800,
    super.repositoryOpacityWhiteHighestDark =
        ColorRawTokens.colorOpacityWhite920,
    super.repositoryOpacityWhiteLowDark = ColorRawTokens.colorOpacityWhite200,
    ...
    super.repositoryOpacityWhiteMediumDark =
        ColorRawTokens.colorOpacityWhite560,
    super.repositoryOpacityWhiteTransparentDark =
        ColorRawTokens.colorOpacityWhite0,
    ...
    super.repositoryPositiveDefaultLight =
        ColorRawTokens.colorFunctionalMalachite500,
    super.repositoryPositiveHighLight =
        ColorRawTokens.colorFunctionalMalachite600,
    super.repositoryPositiveHighestLight =
        ColorRawTokens.colorFunctionalMalachite900,
    super.repositoryPositiveLowLight =
        ColorRawTokens.colorFunctionalMalachite300,
    super.repositoryPositiveLowestLight =
        ColorRawTokens.colorFunctionalMalachite100,
    super.repositoryPositiveDefaultDark =
        ColorRawTokens.colorFunctionalMalachite500,
    super.repositoryPositiveHighDark =
        ColorRawTokens.colorFunctionalMalachite600,
    super.repositoryPositiveHighestDark =
        ColorRawTokens.colorFunctionalMalachite900,
    super.repositoryPositiveLowDark =
        ColorRawTokens.colorFunctionalMalachite300,
    super.repositoryPositiveLowestDark =
        ColorRawTokens.colorFunctionalMalachite100,
    super.repositoryPrimaryDefaultLight = WhiteLabelColorRawTokens.colorBlue500,
    super.repositoryPrimaryLowLight = WhiteLabelColorRawTokens.colorBlue500,
    super.repositoryPrimaryDefaultDark = WhiteLabelColorRawTokens.colorBlue500,
    super.repositoryPrimaryLowDark = WhiteLabelColorRawTokens.colorBlue500,
