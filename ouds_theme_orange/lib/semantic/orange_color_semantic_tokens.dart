...
import 'package:ouds_theme_orange/semantic/orange_color_ai_semantic_tokens.dart';
...
class OrangeColorSemanticTokens extends OudsColorSemanticTokens {
  const OrangeColorSemanticTokens({
    ...
    OrangeColorAiSemanticTokens aiColorTokens =
        const OrangeColorAiSemanticTokens(),
