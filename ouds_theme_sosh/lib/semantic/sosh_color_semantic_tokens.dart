...
import 'package:ouds_theme_sosh/semantic/sosh_color_ai_semantic_tokens.dart';
...
class SoshColorSemanticTokens extends OudsColorSemanticTokens {
  const SoshColorSemanticTokens({
    SoshColorActionSemanticTokens actionColorTokens =
        const SoshColorActionSemanticTokens(),
    SoshColorAiSemanticTokens aiColorTokens = const SoshColorAiSemanticTokens(),
    SoshColorAlwaysSemanticTokens alwaysColorTokens =
        const SoshColorAlwaysSemanticTokens(),
    SoshColorBgSemanticTokens backgroundColorTokens =
        const SoshColorBgSemanticTokens(),
    SoshColorBorderSemanticTokens borderColorTokens =
        const SoshColorBorderSemanticTokens(),
    SoshColorContentSemanticTokens contentColorTokens =
        const SoshColorContentSemanticTokens(),
    SoshColorOpacitySemanticTokens opacityColorTokens =
        const SoshColorOpacitySemanticTokens(),
    SoshColorOverlaySemanticTokens overlayColorTokens =
        const SoshColorOverlaySemanticTokens(),
    SoshColorSurfaceSemanticTokens surfaceColorTokens =
        const SoshColorSurfaceSemanticTokens(),
    SoshColorRepositorySemanticTokens repositoryColorTokens =
