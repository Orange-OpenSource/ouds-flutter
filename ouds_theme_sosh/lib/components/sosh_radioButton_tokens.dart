...
class SoshRadioButtonTokens extends OudsRadioButtonTokens {
  final OudsProvidersTokens providersTokens;

  SoshRadioButtonTokens(this.providersTokens);
  ...
  @override
  double get sizeIndicator => providersTokens.sizeTokens.iconWithLabelLargeSizeXs;
  @override
