<h1 align="center">OUDS Theme Wireframe Flutter Library</h1>

**Theme Wireframe** is a theme for applications built using the OUDS framework. It includes predefined semantic tokens such as colors, typography, and spacing that are consistent with the core "Wireframe" brand identity.
...
To use **Theme Wireframe**, add it as a dependency in your `pubspec.yaml` file.
