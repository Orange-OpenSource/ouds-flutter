...
/// Lightweight wrapper for OudsTypography that qualifies the "ShantellSans" font family with
/// its declaring package.
///
/// The "ShantellSans" font is declared in the `ouds_theme_wireframe` package's `pubspec.yaml`.
/// Flutter requires the `package` argument on [TextStyle] to resolve a font family declared in
/// a package other than the app itself; without it, the style silently falls back to the
...
class WireframeTypography extends OudsTypography {
  static const String _package = 'ouds_theme_wireframe';
